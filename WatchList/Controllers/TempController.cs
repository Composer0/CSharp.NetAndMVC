...
namespace WatchList.Controllers
{
    public class TempController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MovieId,Title,Overview,TagLine,RunTime,ReleaseDate,Rating,VoteAverage,Poster,PosterType,Backdrop,BackdropType,TrailerUrl")] Movie movie)
        {
